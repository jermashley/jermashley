        ...
        <div class="d-flex flex-row justify-content-around flex-wrap">
            <a href="/photography/weddings">
                <div class="d-flex flex-column">
                    <div class="photoStack dropShadow-4 translateY" id="weddings">
            ...
            <a href="/photography/portraits">
                <div class="d-flex flex-column">
                    <div class="photoStack dropShadow-4 translateY" id="portraits">
            ...
            <a href="/photography/point-n-shoot">
                <div class="d-flex flex-column">
                    <div class="photoStack dropShadow-4 translateY" id="point-n-shoot">
