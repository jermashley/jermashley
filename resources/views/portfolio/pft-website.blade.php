		...
		<div class="contentContainer">
			<div class="row">
				<div class="col-lg-6 col-md-12 projectDetails">
					...
					<h4>The Scope</h4>
					<p><em>Passion for Truth</em> had recently undergone a rebrand that was in the final stages of internal review when we started this project. In order to reflect the new branding, management wanted to launch an updated website. This website would not only replace the previous one, but also pack new features &mdash; namely a Video-on-Demand platform.</p>
					<h4>The Timeline</h4>
					<p>We initialized the design of the site on our own as a fast-tracked, side-burner project. The goal was simple: design a website that is welcoming and clear to new users yet remains useful and extensive for the current userbase.</p>
					<h4>The Execution</h4>
					...
					<p>It was, however, equally imperative to maintain a robustness in features and content for the current userbase. Returning visitors needed to use the least amount of clicks or taps to find the content they were looking for &mdash; this through search queries or clear and simple navigation.</p>
